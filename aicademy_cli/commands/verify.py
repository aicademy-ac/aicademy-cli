...
def app_verify(
    ...
    if verify_checks:
        ...
        console.print(f"[dim]Running declarative verification engine...[/dim]\n")
        ...
        message = f"All requirements met ({total_count}/{total_count}). Great work!" if all_passed else f"Keep troubleshooting. {passed_count}/{total_count} tasks passed. Review the checklist above."
        result = {"passed": all_passed, "message": message}
    else:
